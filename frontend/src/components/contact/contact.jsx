...
const ContactComp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(response.data.message||"Thank's for your message.")
    } catch (error) {
  ...
  >
    <div className=" max-w-6xl max-lg:max-w-3xl mx-auto bg-black rounded-lg ">
    <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
      <div>
        ...
        <ul className="flex mt-12 space-x-4">
          <li className="bg-yellow-500 hover:bg-yellow-600 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <input
            type="text"
                ...
                className="placeholder-gray-500 w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]"
          />
          <input
            type="email"
            name="email"
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={6}
            className=" placeholder-gray-500 w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]"
            defaultValue={""}
          />
          <button
            type="submit"
            className="text-black bg-yellow-500 hover:bg-yellow-600 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16px"
          ...
          {success?<div className='text-green-500 my-2'>{success}</div> :""}
